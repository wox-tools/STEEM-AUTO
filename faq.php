	...
	<div class="content" style="padding-left:30px; padding-right:30px;">
		<div class="card">
			<div class="content faq" style="padding-left:30px; padding-right:30px;">
				...
				<h3>Why should I enter my password at steemlogin.com?</h3>
				<p>We are using steemlogin.com to broadcast the transaction which will allow @woxauto to use your account posting authority. To broadcasting this (and any) transaction you will need to input your password.
				...
				<p>No, Steemauto Will not replace / modify / remove your voting priority .</p>
				...
				<p>@wox-helpfund is a charity organized by The world of Xpilar , and with this setup certain percent of your rewards will be sent to this account directly by the blockchain</p>

				<h3>Any other question?</h3>
				<p>Ask your questions from the <a href="https://steemit.com/@xpilar" target="_blank">Contact</a> page.</p>
