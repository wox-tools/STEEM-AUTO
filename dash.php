...
<div class="content">
<center>
<h5 style="color:red; width: 60%; margin: 0 auto;">Please leave Steemauto if you don't understand how it works or what it does. Only Authorize posting to our app if you know what you are doing , Please revoke authorization if you think this is harmful.</h5>
<h3>Welcome <?php echo $name; ?>,</h3>
<br>Please add @woxauto to your account's posting auths using one of following apps:<br>
<br><a class="btn btn-success" href="https://steemlogin.com/authorize/@woxauto/?redirect_uri=https://worldofxpilar.com/dash.php">SteemLogin</a>
<br>
<p>Please allow XPILAR TEAM TO USE YOUR POSTING AUTH FOR THIS TOOL TO WORK</p>
</center>
</div>
</div>
</div>
			...
			<div class="content">
				<div class="card">
					<div class="content">
						...
						<a href="https://steemlogin.com/revoke/@woxauto" class="btn btn-danger">Unauthorize (Leave SteemAuto)</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="card" id="settings">
				<div class="content">
					...
					<script>
						...
						callNode('get_accounts',['<?php echo $name; ?>'], function (result){
							...
							if (percent < <?php echo $powerlimit; ?>) {
								us.innerHTML = 'Paused'
								us.style.color = 'red'
							} else {
								us.innerHTML = 'Normal'
					...
					<strong>Limit on Mana:</strong><span> <?php echo $powerlimit; ?>% <a onclick="$('#limitpower').toggle(500)">(Click to edit)</a></span><br>
					...
					<p>You can check your Mana here: <a href="https://steemd.com/@<?php echo $name; ?>">https://steemd.com/@<?php echo $name; ?></a></p>
