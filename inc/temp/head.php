	...
	<div class="wrapper" >
		<div class="sidebar" data-color="blue">
			...
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="dash.php" class="simple-text">
						STEEM AUTOMATION
					</a>
				</div>
				...
				<ul class="nav">
				   ...
				   <?php if($log){ ?> <li <?php if($active ==1){echo 'class="active"';} ?>>
						<a href="dash.php">
			...
			<nav class="navbar navbar-inverse navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<i class="fa fa-align-justify" aria-hidden="true"  class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2" ></i>
