			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<p class="copyright">
						...
						<!-- <br> -->
						<a href="/privacy-policy.php">Privacy Policy</a> | <a href="/about-us.php">About us</a> | <a href="https://steemit.com/@xpilar">Contact</a>
					</p>
					</center>
				</div>
			</footer>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<br><br><a href="https://steemlogin.com/sign/account-witness-vote?witness=mahdiyari&approve=1" target="_blank">Vote by steemconnect</a> or <a href="https://steemit.com/~witnesses" target="_blank">Vote by steemit</a>
				</div>
