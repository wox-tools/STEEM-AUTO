...
function follow(user){ //follow a trail
	callApi('<?php echo $BACKENDSERVER; ?>api/v1/dashboard/curation-trail/follow', 'trail=' + encodeURIComponent(user))
	return 1
}
function unfollow(user){ //unfollow a trail
	callApi('<?php echo $BACKENDSERVER; ?>api/v1/dashboard/curation-trail/unfollow', 'trail=' + encodeURIComponent(user))
	return 1
}
let recent = null
let recentl = null
...
function settings(user){ //settings for trail
	...
	callApi('<?php echo $BACKENDSERVER; ?>api/v1/dashboard/curation-trail/settings', body)
	return 1
}
...
function updateTrail(){
	callApi('<?php echo $BACKENDSERVER; ?>api/v1/dashboard/curation-trail/update')
